...
ActiveRecord::Schema.define(version: 2019_04_25_163115) do
  ...
  create_table "join_specialty_doctors", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["doctor_id"], name: "index_join_specialty_doctors_on_doctor_id"
    t.index ["specialty_id"], name: "index_join_specialty_doctors_on_specialty_id"
  end
